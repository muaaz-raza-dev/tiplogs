import { GetMetaAttendanceInfo, ValidateDateAndIdApi } from "@/app/api/mark_att.api";
...
export function useGetMarkAttMetaData() {
  ...
  useEffect(() => {
  if(query.isSuccess){
    setState({...state,module:query.data.payload.module,group:query.data.payload.group,general:{...state.general,total_individuals:query.data.payload.total_individuals}})
