      ...
      <Card className="w-full  mx-auto">
        ...
        <PhotoComponent photo={photo} name={p.full_name}/>
          <div className="text-center sm:text-left">
            <CardTitle className="text-3xl font-bold">{s.personal_details.full_name}</CardTitle>
            <p className="text-muted-foreground text-lg">{s.personal_details.father_name}</p>
          </div>
          </div>
        ...
        <CardContent className="grid gap-4 ">
          ...
          <div className="border-b-2 py-4">
            ...
            <DescriptionList  items={p} />
          </div>
          <div className="border-b-2 py-4">
            <h2 className="text-xl font-semibold mb-4 ">Acedmic Information</h2>
            <DescriptionList  items={s.acedemic_details} />
          </div>
          <div className=" py-4">
            <h2 className="text-xl font-semibold mb-4">Account Information</h2>
            <DescriptionList  items={s.account_details} />
          </div>
        </CardContent>
      </Card>
    </div>
