...
import { AttModuleGroupDetailsDailyAtom } from '@/lib/atoms/att-details-group-module.atom'
...
function Filterbar() {
    ...
    const [filters,setFilters] = useAtom(AttModuleGroupDetailsDailyAtom)
          ...
          <CardContent>
            <div className="flex gap-4 items-end">
              ...
              <div className="w-full">
                ...
                <Select value={filters.group} onValueChange={(e)=>setFilters({...filters,module:e})} >
                  <SelectTrigger className="w-full">
